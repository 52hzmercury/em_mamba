...
"""
python scripts/pediatric/complete_pediatrics_filelist.py --dataset /workdir1/cn24/data/pediatric_echo/A4C
python scripts/pediatric/complete_pediatrics_filelist.py --dataset /workdir1/cn24/data/pediatric_echo/PSAX
"""
